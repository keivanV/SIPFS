...
mongoose.connect('mongodb://192.168.1.3:27017/sipfs', {
...
app.post('/upload', authenticateToken, upload.single('file'), async (req, res) => {
    const { policyAttributes, metadata, version, promoteAttributes } = req.body; // اضافه شدن promoteAttributes
    ...
    try {
        ...
        let promoteAttributesArray = []; // پردازش promoteAttributes
            ...
            if (version == "demo") {
                ...
                const result = await submitTransactionWithRetry(
                    ...
                    [
                        ...
                        JSON.stringify(hashedPromoteAttributes) // اضافه شدن promoteAttributes به CreateAsset
                    ],
                    5,
                    1000
                );
        ...
        res.status(201).json({
            ...
            data: {
                ...
                promoteAttributes: promoteAttributesArray, // اضافه شدن به پاسخ
                publicKeyOwner,
...
app.post('/promote', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            // مدیریت خطای عدم تطابق ویژگی‌ها
            ...
            throw error; // سایر خطاها به صورت عادی مدیریت شوند
        }
